...
class Bob(Party):
    e_value = [(0, 0)]  # append with dummy, since in notes we start notation at 1, and in python at 0
    d_value = None
    keys = [(0, 0)]  # append with dummy, since in notes we start notation at 1, and in python at 0
    Z_value = 0
